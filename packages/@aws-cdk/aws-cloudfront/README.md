...
### Invalidating Older Resources So Updates Go Live Faster

If you need to remove one or more files from CloudFront edge caches before they expires, you can invalidate the paths to the files. To invalidate files, you can specify either the path for individual files or a path that ends with the * wildcard.
See https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/controlling-origin-requests.html for more details.
...
distribution.clearEdgeCaches(invalidatePaths);
// Or
